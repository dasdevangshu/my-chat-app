...
import { sendSignUpServer } from "../lib/sendSignUpServer";
...
export default function SignUp() {
    ...
    const [signUpMessage, setSignUpMessage] = useState("enter your username and password and sign up!")
    ...
    async function sendSignUp() {
        try {
            const res = await sendSignUpServer(username, password)
            //console.log(res)
    ...
    useEffect(() => {
        setSignUpMessage("enter your username and password and log in!")
    }, [username, password])
    ...
    useEffect(() => {
        setSignUpMessage("enter your username and password and sign up!")
    }, [username, password])
    ...
    const signUpValidationStyle = signUpMessage === 'enter your username and password and sign up!'? ' text-green-600 ' : ' text-red-600 '
            ...
            <div className="w-full h-full flex flex-col items-center sm:justify-center gap-2">
                ...
                <div className=" border rounded-md border-slate-300 dark:border-slate-900 p-8 gap-8 w-4/5 max-w-80 flex flex-col justify-center items-center">
                    ...
                    <div className=" w-full flex gap-2 flex-col items-center">
                        ...
                        <button className={buttonStyle} onClick={() => { router.push(`${process.env.NEXT_PUBLIC_API_URL}/login/github`) }}>SignUp using Github</button>
                    </div>

...
const acceptIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6 hover:text-green-600 dark:hover:text-green-600 text-slate-500 dark:text-teal-50 hover:scale-110 transition duration-300 ease-in-out">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg>

const rejectIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6 hover:text-red-600 dark:hover:text-red-600 text-slate-500 dark:text-teal-50 hover:scale-110 transition duration-300 ease-in-out">
